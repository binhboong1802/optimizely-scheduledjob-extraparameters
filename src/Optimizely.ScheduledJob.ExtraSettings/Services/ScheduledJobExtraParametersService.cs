...
{
    [ServiceConfiguration(typeof(IScheduledJobExtraParametersService), Lifecycle = ServiceInstanceScope.Singleton)]
    public class ScheduledJobExtraParametersService : IScheduledJobExtraParametersService
    {
        ...
        public ScheduledJobExtraParametersService(DynamicDataStoreFactory factory)
        {
            _factory = factory;
        }
